...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'address_id' => $addressUbs->id, 'start_date' => '2021-02-01', 'end_date' => '2021-02-28', 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/ubs-1024-758683775 1.png',                      'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2021',   'public_token' => Str::random(32), 'nb_registered' => 163]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'address_id' => $addressUbs->id, 'start_date' => '2023-02-01', 'end_date' => '2023-02-28', 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/ubs-1024-758683775 1.png',                      'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2023',   'public_token' => Str::random(32), 'nb_registered' => 250]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'address_id' => $addressUbs->id, 'start_date' => '2024-03-01', 'end_date' => '2024-03-31', 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/ubs-1024-758683775 1.png',                      'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2024',   'public_token' => Str::random(32), 'nb_registered' => 300]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'address_id' => $addressUbs->id, 'start_date' => '2025-04-01', 'end_date' => '2025-04-30', 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/ubs-1024-758683775 1.png',                      'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2025',   'public_token' => Str::random(32), 'nb_registered' => 320]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'address_id' => $addressUbs->id, 'start_date' => '2026-05-01', 'end_date' => '2026-06-30', 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/ubs-1024-758683775 1.png',                      'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2026',   'public_token' => Str::random(32), 'nb_registered' => 150]);

        // Coop (2022, 2023, 2024, 2025 terminées + 2026 en cours)
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'address_id' => $addressCoop->id, 'start_date' => '2022-05-01', 'end_date' => '2022-05-31', 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/Coop_(Switzerland)-Logo.wine-1486175068 1.png',                     'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2022',  'public_token' => Str::random(32), 'nb_registered' => 169]);
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'address_id' => $addressCoop->id, 'start_date' => '2023-05-01', 'end_date' => '2023-05-31', 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/Coop_(Switzerland)-Logo.wine-1486175068 1.png',                     'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2023',  'public_token' => Str::random(32), 'nb_registered' => 180]);
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'address_id' => $addressCoop->id, 'start_date' => '2024-06-01', 'end_date' => '2024-06-30', 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/Coop_(Switzerland)-Logo.wine-1486175068 1.png',                     'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2024',  'public_token' => Str::random(32), 'nb_registered' => 200]);
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'address_id' => $addressCoop->id, 'start_date' => '2025-07-01', 'end_date' => '2025-08-15', 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/Coop_(Switzerland)-Logo.wine-1486175068 1.png',                     'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2025',  'public_token' => Str::random(32), 'nb_registered' => 220]);
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'address_id' => $addressCoop->id, 'start_date' => '2026-06-01', 'end_date' => '2026-07-15', 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/Coop_(Switzerland)-Logo.wine-1486175068 1.png',                     'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2026',  'public_token' => Str::random(32), 'nb_registered' => 110]);

        // Nestlé (2021, 2022, 2023 terminées + 2026 en cours)
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'address_id' => $addressNestle->id, 'start_date' => '2021-05-15', 'end_date' => '2021-05-31', 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/Nestle-Logo-3126327959 1.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2021','public_token' => Str::random(32), 'nb_registered' => 171]);
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'address_id' => $addressNestle->id, 'start_date' => '2022-03-15', 'end_date' => '2022-03-31', 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/Nestle-Logo-3126327959 1.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2022','public_token' => Str::random(32), 'nb_registered' => 146]);
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'address_id' => $addressNestle->id, 'start_date' => '2023-03-15', 'end_date' => '2023-03-31', 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/Nestle-Logo-3126327959 1.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2023','public_token' => Str::random(32), 'nb_registered' => 350]);
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'address_id' => $addressNestle->id, 'start_date' => '2026-05-15', 'end_date' => '2026-07-15', 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/Nestle-Logo-3126327959 1.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2026','public_token' => Str::random(32), 'nb_registered' => 180]);
