...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@ubs.ch', 'contact_phone' => '+41 44 234 85 00', 'venue_street' => $addressUbs->street, 'venue_number' => $addressUbs->number, 'venue_postal_code' => $addressUbs->postal_code, 'venue_city' => $addressUbs->city, 'start_date' => '2024-03-01', 'end_date' => '2024-03-31', 'capacity' => 75, 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-ubs.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2024',    'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@ubs.ch', 'contact_phone' => '+41 44 234 85 00', 'venue_street' => $addressUbs->street, 'venue_number' => $addressUbs->number, 'venue_postal_code' => $addressUbs->postal_code, 'venue_city' => $addressUbs->city, 'start_date' => '2025-04-01', 'end_date' => '2025-04-30', 'capacity' => 75, 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-ubs.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2025',    'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $ubs->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@ubs.ch', 'contact_phone' => '+41 44 234 85 00', 'venue_street' => $addressUbs->street, 'venue_number' => $addressUbs->number, 'venue_postal_code' => $addressUbs->postal_code, 'venue_city' => $addressUbs->city, 'start_date' => '2026-05-01', 'end_date' => '2026-06-30', 'capacity' => 80, 'primary_color' => '#EB001B', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-ubs.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/ubs-2026',    'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // Coop (2022, 2023, 2024, 2025 terminées + 2026 en cours)
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@coop.ch', 'contact_phone' => '+41 44 724 72 47', 'venue_street' => $addressCoop->street, 'venue_number' => $addressCoop->number, 'venue_postal_code' => $addressCoop->postal_code, 'venue_city' => $addressCoop->city, 'start_date' => '2022-05-01', 'end_date' => '2022-05-31', 'capacity' => 50, 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-coop.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2022',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@coop.ch', 'contact_phone' => '+41 44 724 72 47', 'venue_street' => $addressCoop->street, 'venue_number' => $addressCoop->number, 'venue_postal_code' => $addressCoop->postal_code, 'venue_city' => $addressCoop->city, 'start_date' => '2023-05-01', 'end_date' => '2023-05-31', 'capacity' => 50, 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-coop.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2023',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        ...
        Collection::create(['company_id' => $coop->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@coop.ch', 'contact_phone' => '+41 44 724 72 47', 'venue_street' => $addressCoop->street, 'venue_number' => $addressCoop->number, 'venue_postal_code' => $addressCoop->postal_code, 'venue_city' => $addressCoop->city, 'start_date' => '2026-06-01', 'end_date' => '2026-07-15', 'capacity' => 60, 'primary_color' => '#FF6B35', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-coop.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/coop-2026',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        ...
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@nestle.ch', 'contact_phone' => '+41 21 924 24 24', 'venue_street' => $addressNestle->street, 'venue_number' => $addressNestle->number, 'venue_postal_code' => $addressNestle->postal_code, 'venue_city' => $addressNestle->city, 'start_date' => '2023-03-15', 'end_date' => '2023-03-31', 'capacity' => 45, 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-nestle.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2023', 'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $nestle->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@nestle.ch', 'contact_phone' => '+41 21 924 24 24', 'venue_street' => $addressNestle->street, 'venue_number' => $addressNestle->number, 'venue_postal_code' => $addressNestle->postal_code, 'venue_city' => $addressNestle->city, 'start_date' => '2026-05-15', 'end_date' => '2026-07-15', 'capacity' => 50, 'primary_color' => '#6B4423', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-nestle.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/nestle-2026', 'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // Rolex (2021, 2022, 2023, 2025 terminées)
        Collection::create(['company_id' => $rolex->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@rolex.ch', 'contact_phone' => '+41 22 302 22 00', 'venue_street' => $addressRolex->street, 'venue_number' => $addressRolex->number, 'venue_postal_code' => $addressRolex->postal_code, 'venue_city' => $addressRolex->city, 'start_date' => '2021-04-01', 'end_date' => '2021-04-30', 'capacity' => 30, 'primary_color' => '#000000', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/rolex-2021',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $rolex->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@rolex.ch', 'contact_phone' => '+41 22 302 22 00', 'venue_street' => $addressRolex->street, 'venue_number' => $addressRolex->number, 'venue_postal_code' => $addressRolex->postal_code, 'venue_city' => $addressRolex->city, 'start_date' => '2022-06-01', 'end_date' => '2022-06-30', 'capacity' => 30, 'primary_color' => '#000000', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/rolex-2022',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $rolex->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@rolex.ch', 'contact_phone' => '+41 22 302 22 00', 'venue_street' => $addressRolex->street, 'venue_number' => $addressRolex->number, 'venue_postal_code' => $addressRolex->postal_code, 'venue_city' => $addressRolex->city, 'start_date' => '2023-07-01', 'end_date' => '2023-07-31', 'capacity' => 35, 'primary_color' => '#000000', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/rolex-2023',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $rolex->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@rolex.ch', 'contact_phone' => '+41 22 302 22 00', 'venue_street' => $addressRolex->street, 'venue_number' => $addressRolex->number, 'venue_postal_code' => $addressRolex->postal_code, 'venue_city' => $addressRolex->city, 'start_date' => '2025-08-01', 'end_date' => '2025-08-31', 'capacity' => 35, 'primary_color' => '#000000', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/rolex-2025',   'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // Migros (2025, 2026)
        Collection::create(['company_id' => $migros->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@migros.ch', 'contact_phone' => '+41 58 570 00 00', 'venue_street' => $addressMigros->street, 'venue_number' => $addressMigros->number, 'venue_postal_code' => $addressMigros->postal_code, 'venue_city' => $addressMigros->city, 'start_date' => '2025-09-01', 'end_date' => '2025-09-30', 'capacity' => 100, 'primary_color' => '#FF6600', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-migros.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/migros-2025',  'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $migros->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@migros.ch', 'contact_phone' => '+41 58 570 00 00', 'venue_street' => $addressMigros->street, 'venue_number' => $addressMigros->number, 'venue_postal_code' => $addressMigros->postal_code, 'venue_city' => $addressMigros->city, 'start_date' => '2026-04-01', 'end_date' => '2026-05-15', 'capacity' => 100, 'primary_color' => '#FF6600', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-migros.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/migros-2026',  'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // Swisscom (2024, 2026 en cours)
        Collection::create(['company_id' => $swisscom->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@swisscom.ch', 'contact_phone' => '+41 58 221 21 11', 'venue_street' => $addressSwisscom->street, 'venue_number' => $addressSwisscom->number, 'venue_postal_code' => $addressSwisscom->postal_code, 'venue_city' => $addressSwisscom->city, 'start_date' => '2024-10-01', 'end_date' => '2024-10-31', 'capacity' => 90, 'primary_color' => '#0066CC', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/swisscom-2024', 'kit_url' => $kit, 'public_token' => Str::random(32)]);
        Collection::create(['company_id' => $swisscom->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@swisscom.ch', 'contact_phone' => '+41 58 221 21 11', 'venue_street' => $addressSwisscom->street, 'venue_number' => $addressSwisscom->number, 'venue_postal_code' => $addressSwisscom->postal_code, 'venue_city' => $addressSwisscom->city, 'start_date' => '2026-05-01', 'end_date' => '2026-06-30', 'capacity' => 90, 'primary_color' => '#0066CC', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/swisscom-2026', 'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // La Poste (2025)
        Collection::create(['company_id' => $laPoste->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@poste.ch', 'contact_phone' => '+41 58 338 00 00', 'venue_street' => $addressLaPoste->street, 'venue_number' => $addressLaPoste->number, 'venue_postal_code' => $addressLaPoste->postal_code, 'venue_city' => $addressLaPoste->city, 'start_date' => '2025-01-15', 'end_date' => '2025-02-15', 'capacity' => 70, 'primary_color' => '#FFCC00', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/poste-2025',   'kit_url' => $kit, 'public_token' => Str::random(32)]);

        // Swatch (2026)
        Collection::create(['company_id' => $swatch->id, 'user_id' => $adminUser->id, 'contact_email' => 'contact@swatch.ch', 'contact_phone' => '+41 32 343 90 00', 'venue_street' => $addressSwatch->street, 'venue_number' => $addressSwatch->number, 'venue_postal_code' => $addressSwatch->postal_code, 'venue_city' => $addressSwatch->city, 'start_date' => '2026-03-01', 'end_date' => '2026-03-31', 'capacity' => 45, 'primary_color' => '#FF0000', 'secondary_color' => '#c44444', 'logo_url' => '/images/logos/logo-hug.png', 'onedoc_url' => 'https://onedoc.hug.ch/collections/swatch-2026',   'kit_url' => $kit, 'public_token' => Str::random(32)]);
