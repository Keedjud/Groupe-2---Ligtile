...
- [ ] `cobrand/constants/quizQuestions.js` — slugs stables P1 + P2 _(à aligner dans `DashboardMetricsController` après Phase 7D)_
...
**8C — Nommage `ApiTropheeController`** _(à faire après Phase 7D)_
